...
public class income extends javax.swing.JFrame {
    ...
    public income() {
        ...
        try {
            DefaultTableModel dtm =(DefaultTableModel)table5.getModel();
            ResultSet rs = dbcon.SEARCH("SELECT*FROM orders");
            while(rs.next()){
                String id = rs.getString("id");
                String name = rs.getString("name");
                String gender = rs.getString("product_type");
                String email = rs.getString("quantity");
                String phone = rs.getString("total"); 
                String address = rs.getString("company_name");
    ...
    private void initComponents() {
        ...
        table5.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Date", "Category", "Selling Quantity", "Selling Income", "Selling Company"
            }
        ));
